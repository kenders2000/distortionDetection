...
${OBJECTDIR}/src/distFeats.o: nbproject/Makefile-${CND_CONF}.mk src/distFeats.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/distFeats.o src/distFeats.c
